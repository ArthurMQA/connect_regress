...
public class ConnectMeetingPage {

    private WebDriver driver;
    private WebDriverWait wait;

    public ConnectMeetingPage(WebDriver driver) {
    ...
    @FindBy(xpath ="//*[@class='presentation-dropzone']/input")
    ...
    public ConnectMeetingPage checkThatMeetingStartedSuccessfully() {
