Feature: As user I want to log into the ADX Connect service and start the new meeting

  Scenario: I want to log into ADX Connect service and start the meeting
